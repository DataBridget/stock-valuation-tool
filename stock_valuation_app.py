...
def main():
    ...
    def recommend_params(name, pe_ttm, pb_mrq, roe_val, yoy_np_val):
        ...
        # 新能源/光伏/锂电
        elif any(k in name for k in ['新能源', '光伏', '太阳能', '风电', '锂电', '宁德', '比亚迪', '隆基', '通威', '阳光电源', '晶科', '晶澳', '天合', '阿特斯', '东方日升', '爱旭', '钧达', '中来', '协鑫', 'TCL中环', '京运通', '双良', '上机', '高测', '宇晶', '欧晶', '福莱特', '信义', '旗滨', '南玻', '金晶', '亚玛顿', '安彩', '洛阳玻璃', '金刚玻璃', '德力', '秀强', '拓日新能', '亿晶光电', '珈伟新能', '清源股份', '芯能科技', '晶科科技', '太阳能', '林洋能源', '正泰电器', '特变电工', '国电南瑞', '许继电气', '平高电气', '中国西电', '思源电气', '特锐德', '科士达', '科华数据', '英维克', '高澜股份', '同飞股份', '申菱环境', '依米康', '佳力图', '朗进科技', '祥鑫科技', '铭科精技', '文灿股份', '爱柯迪', '旭升集团', '嵘泰股份', '立中集团', '永茂泰', '明泰铝业', '常铝股份', '华峰铝业', '南山铝业', '云铝股份', '神火股份', '中国铝业', '天山铝业', '中孚实业', '怡球资源', '顺博合金', '永茂泰', '立中集团', '四通新材', '云海金属', '宝武镁业', '宜安科技', '福达合金', '温州宏丰', '电工合金', '博威合金', '楚江新材', '精达股份', '长城科技', '金杯电工', '远东股份', '起帆电缆', '万马股份', '东方电缆', '中天科技', '亨通光电', '通光线缆', '特发信息', '汇源通信', '永鼎股份', '通鼎互联', '中利集团', '兆龙互连', '新亚电子', '卡倍亿', '沪光股份', '大地电气', '立讯精密', '歌尔股份', '蓝思科技', '领益智造', '鹏鼎控股', '环旭电子', '立讯精密', '工业富联', '闻泰科技', '传音控股', '中兴通讯', '烽火通信', '光迅科技', '中际旭创', '新易盛', '天孚通信', '剑桥科技', '华工科技', '博创科技', '太辰光', '德科立', '联特科技', '源杰科技', '长光华芯', '仕佳光子', '腾景科技', '德科立', '联特科技', '源杰科技', '长光华芯', '仕佳光子', '腾景科技']):
